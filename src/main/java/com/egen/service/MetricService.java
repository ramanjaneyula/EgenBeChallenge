...
import com.egen.rules.RuleFactory;
...
public class MetricService {
    ...
    public ObjectId createMetric(Metric metric) {
        rule = RuleFactory.getRule(MetricsRule.RuleType.UNDER_WEIGHT, metric);
        rulesEngine.registerRule(rule);
        rule = RuleFactory.getRule(MetricsRule.RuleType.OVER_WEIGHT, metric);
        rulesEngine.registerRule(rule);
